<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteForm.aspx.cs" Inherits="WoW_Toons.DeleteForm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="menu">
            ...
            <br />
            <br />
            <asp:LinkButton ID="lnkDeleteToon" runat="server" Font-Underline="False" Font-Size="Large">Delete Toon</asp:LinkButton>
            <br />
            <br />
            ...
            <div class="main">
                ...
                <asp:DropDownList ID="ddlToons" runat="server" AppendDataBoundItems="true">
